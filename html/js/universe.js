...
dc.write('<style> #uv_pop{background:#FFF;z-index:99;position:absolute;top:50%;left:50%;display:none;border:5px solid #FFF} #uv_px {font-weight:bold;color:red;float:right} #uv_ov{position:absolute;top:0;left:0;z-index:90;background-color:#000;display:none;opacity:.7} </style>');
return {
